...
public class AnimalTest {
    ...
    public void setPositionTest() {
        ...
        Animal animalTest = new Animal(map);

        Assert.assertNull(animalTest.getPosition());                // sprawdzam czy jest napewno pusty

        animalTest.setPosition(new Vector2d(5, 3));

        Assert.assertNotNull(animalTest.getPosition());             // sprawdzam czy wskoczylo
    }
