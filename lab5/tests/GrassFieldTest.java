...
public class GrassFieldTest {
    ...
    public void isOccupiedByAnimalTest(){
        ...
        Assert.assertTrue(fields.place(animal));
    ...
    public void canMoveToTest(){
        ...
        Assert.assertFalse(fields.canMoveTo(new Vector2d(8,1)));
        Assert.assertFalse(fields.canMoveTo(new Vector2d(1,8)));
        Assert.assertFalse(fields.canMoveTo(new Vector2d(8,8)));
        Assert.assertFalse(fields.canMoveTo(new Vector2d(-1,1)));
        Assert.assertFalse(fields.canMoveTo(new Vector2d(1,-1)));
        Assert.assertFalse(fields.canMoveTo(new Vector2d(-1,-1)));
        Assert.assertTrue(fields.canMoveTo(new Vector2d(1,1)));
    ...
    public void placeTest(){
        ...
        Assert.assertTrue(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(0,0)));
        Assert.assertEquals(fields.objectAt(new Vector2d(0,0)),animal);

        animal=new Animal(fields,new Vector2d(1,1));                           // wstawia na 1,1
        Assert.assertTrue(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(1,1)));
        Assert.assertEquals(fields.objectAt(new Vector2d(1,1)),animal);

        animal=new Animal(fields,new Vector2d(1,0));                           // proboje na 1,0
        Assert.assertTrue(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(1,0)));
        Assert.assertEquals(fields.objectAt(new Vector2d(1,0)),animal);

        animal=new Animal(fields,new Vector2d(0,1));                           // wstawia na 0,1
        Assert.assertTrue(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(0,1)));
        Assert.assertEquals(fields.objectAt(new Vector2d(0,1)),animal);

        animal=new Animal(fields);                                                  // proboje wstawic na 0,0
        Assert.assertFalse(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(0,0)));
        Assert.assertNotEquals(fields.objectAt(new Vector2d(0,0)),animal);

        animal=new Animal(fields,new Vector2d(1,1));                          // proboje wstawic na 1,1
        Assert.assertFalse(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(1,1)));
        Assert.assertNotEquals(fields.objectAt(new Vector2d(1,1)),animal);

        animal=new Animal(fields,new Vector2d(0,1));                          // proboje wstawic na 0,1
        Assert.assertFalse(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(0,1)));
        Assert.assertNotEquals(fields.objectAt(new Vector2d(0,1)),animal);

        animal=new Animal(fields,new Vector2d(1,0));                          // proboje wstawic na 1,0
        Assert.assertFalse(fields.place(animal));
        Assert.assertNotNull(fields.objectAt(new Vector2d(1,0)));
        Assert.assertNotEquals(fields.objectAt(new Vector2d(1,0)),animal);
    }
    ...
    public void runTest() {
        ...
        Assert.assertTrue(fields.place(animal));
        Assert.assertTrue(fields.place(animal2));
        ...
        Assert.assertTrue(fields.place(animal3));
