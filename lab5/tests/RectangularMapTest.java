...
public class RectangularMapTest {
    ...
    public void placeTest(){
        ...
        Assert.assertNotNull(square.objectAt(new Vector2d(0,0)));
        Assert.assertNotEquals(square.objectAt(new Vector2d(0,0)),animal);

        animal=new Animal(square,new Vector2d(1,1));                          // proboje wstawic na 1,1
        Assert.assertFalse(square.place(animal));
        Assert.assertNotNull(square.objectAt(new Vector2d(1,1)));
        Assert.assertNotEquals(square.objectAt(new Vector2d(1,1)),animal);

        animal=new Animal(square,new Vector2d(0,1));                          // proboje wstawic na 0,1
        Assert.assertFalse(square.place(animal));
        Assert.assertNotNull(square.objectAt(new Vector2d(0,1)));
        Assert.assertNotEquals(square.objectAt(new Vector2d(0,1)),animal);

        animal=new Animal(square,new Vector2d(1,0));                          // proboje wstawic na 1,0
        Assert.assertFalse(square.place(animal));
        Assert.assertNotNull(square.objectAt(new Vector2d(1,0)));
        Assert.assertNotEquals(square.objectAt(new Vector2d(1,0)),animal);
    }
    ...
    public void runTest(){
        ...
        Assert.assertTrue(square.place(animal4));
        ...
        Assert.assertNotNull(square.objectAt(new Vector2d(0,3)));
        Assert.assertEquals(square.objectAt(new Vector2d(0,3)),animal3);
        Assert.assertNotNull(square.objectAt(new Vector2d(3,0)));
